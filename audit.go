// Package gauth provides audit logging for the GAuth protocol.
//
...
type securityEvent struct {
	...
	EventType     gauth.EventType `json:"event_type"`
...
func (al *AuditLogger) LogEvent(evt gauth.EventType, transactionID, clientID string, meta EventMetadata) {
	al.mu.Lock()
	defer al.mu.Unlock()
	...
	event.Success = meta.ErrorMsg == "" && evt != gauth.EventTransactionFailed && evt != gauth.EventRateLimited
