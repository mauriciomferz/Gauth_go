...
//	RFCRef: optional RFC clause reference (e.g. "AAP001:replay_protection").
...
func respondError(c *gin.Context, status int, code, errStr, msg, rfcRef string, detail interface{}) {
	...
	envelope := ErrorEnvelope{
		Code: code, Message: msg, Details: det, Retryable: retryable,
		Source: "agentauth", Error: errStr, Success: false,
	}
