...
import { gauthPlusAPI, FiduciaryDutyViolation } from '../../lib/gauthplus-api'
...
export default function FiduciaryPanel() {
  ...
  const fetchViolations = async () => {
    try {
      ...
      let response
      if (severityFilter) {
        response = await gauthPlusAPI.getViolationsBySeverity(severityFilter)
      } else {
        response = await gauthPlusAPI.getViolations(poaId || undefined)
      }
