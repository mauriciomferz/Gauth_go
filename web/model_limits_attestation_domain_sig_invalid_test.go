...
func TestModelLimitsAttestationDomainSignatureInvalid(t *testing.T) {
	...
	if v["error"] != "domain_signature_invalid" {
		t.Fatalf("expected error domain_signature_invalid got %+v", v)
	}
