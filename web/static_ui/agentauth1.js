...
// API Base URL
const API_BASE = '/api/v1/agentauth';
...
async function loadMetrics() {
    ...
    // In a real app, this would fetch from /api/v1/agentauth/metrics
...
async function registerMCPServer() {
    ...
    try {
        ...
        const response = await fetch('/api/v1/agentauth/mcp/servers', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function selectMCPServer(serverId) {
    ...
    try {
        // Load resources
        const resourcesResponse = await fetch(`/api/v1/agentauth/mcp/servers/${serverId}/resources`);
        ...
        // Load tools
        const toolsResponse = await fetch(`/api/v1/agentauth/mcp/servers/${serverId}/tools`);
        if (toolsResponse.ok) {
...
async function readMCPResource(uri) {
    try {
        const response = await fetch(`/api/v1/agentauth/mcp/servers/${mcpState.selectedServerId}/resources/read`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function executeMCPTool() {
    ...
    try {
        ...
        const response = await fetch(`/api/v1/agentauth/mcp/servers/${mcpState.selectedServerId}/tools/call`, {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function disconnectMCPServer(serverId, event) {
    ...
    try {
        const response = await fetch(`/api/v1/agentauth/mcp/servers/${serverId}`, {
            method: 'DELETE'
        });
...
async function handleLoginCredentials() {
    ...
    try {
        ...
        const response = await fetch('/api/v1/agentauth/auth/login/init', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function handleLoginMFA() {
    ...
    try {
        ...
        const response = await fetch('/api/v1/agentauth/auth/mfa/verify', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
