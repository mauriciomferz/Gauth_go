...
type FiduciaryHandlers struct {
	service agentauthplus.FiduciaryDutyService
}
...
// ResolveViolation handles POST /api/v1/agentauthplus/fiduciary/violations/:id/resolve
...
// GetViolationsBySeverity handles GET /api/v1/agentauthplus/fiduciary/violations/by-severity
