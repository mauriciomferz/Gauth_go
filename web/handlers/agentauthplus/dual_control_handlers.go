...
type DualControlHandlers struct {
	service agentauthplus.DualControlService
}
...
// ApproveAction handles POST /api/v1/agentauthplus/dual-control/approvals/:id/approve
...
// RejectAction handles POST /api/v1/agentauthplus/dual-control/approvals/:id/reject
...
// GetApprovalStatus handles GET /api/v1/agentauthplus/dual-control/approvals/:id/status
...
// GetPendingApprovals handles GET /api/v1/agentauthplus/dual-control/approvals/pending
...
// FindApprovalsByPoAAndAction handles GET /api/v1/agentauthplus/dual-control/approvals/query
