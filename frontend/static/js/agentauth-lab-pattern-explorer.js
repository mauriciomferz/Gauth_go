...
window.AgentAuthLab.PatternExplorer = {
    ...
    exportPattern: function(patternId) {
        ...
        a.href = url;
        a.download = `agentauth-pattern-${patternId}-${Date.now()}.json`;
    ...
    savePattern: function(patternId) {
        ...
        const savedPatterns = JSON.parse(localStorage.getItem('agentauth-saved-patterns') || '{}');
        savedPatterns[patternId] = {
            ...pattern,
            savedAt: new Date().toISOString()
        };
        localStorage.setItem('agentauth-saved-patterns', JSON.stringify(savedPatterns));
