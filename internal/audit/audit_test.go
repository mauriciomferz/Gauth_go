...
func TestAuditLogger(t *testing.T) {
	t.Run("Logger Creation", testLoggerCreation)
	t.Run("Log and GetRecent", testLogAndGetRecent)
	t.Run("Max Size Enforcement", testMaxSizeEnforcement)
	t.Run("Query Events", testQueryEvents)
	t.Run("Clear Events", testClearEvents)
}
