...
func (m *Memory) IncModelUserInputLimitExceeded()  { atomic.AddUint64(&m.modelUserInputLimitExceeded, 1) }
func (m *Memory) IncModelUserOutputLimitExceeded() { atomic.AddUint64(&m.modelUserOutputLimitExceeded, 1) }
...
func (m *Memory) ModelUserInputLimitExceeded() uint64  { return atomic.LoadUint64(&m.modelUserInputLimitExceeded) }
func (m *Memory) ModelUserOutputLimitExceeded() uint64 { return atomic.LoadUint64(&m.modelUserOutputLimitExceeded) }
func (m *Memory) ModelUserRateLimitExceeded() uint64   { return atomic.LoadUint64(&m.modelUserRateLimitExceeded) }
// Capability enforcement accessor helpers (for tests / diagnostics)
func (m *Memory) CapabilityEnforceAllowed() uint64 { return atomic.LoadUint64(&m.capabilityEnforceAllowed) }
func (m *Memory) CapabilityEnforceDenied() uint64  { return atomic.LoadUint64(&m.capabilityEnforceDenied) }
