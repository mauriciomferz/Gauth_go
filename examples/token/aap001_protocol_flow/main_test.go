...
func TestAAP001ProtocolFlowOutput(t *testing.T) {
	...
	// Current implementation prints a 'Get after revoke error:' line instead of explicit 'Token revoked:' when fetch returns an error.
	// Accept absence of 'Token revoked: true' while retaining backward compatibility if added later.
