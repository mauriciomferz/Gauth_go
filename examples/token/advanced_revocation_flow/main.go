...
// # Licensing
//
// This file is part of the AgentAuth project and is licensed under the Apache License 2.0.
...
func main() {
	// --- Multi-Attestation Token Issuance ---
	...
	revokeIdx := 1 // agent-2
	if err := store.Revoke(ctx, delegateTokens[revokeIdx].ID, "selective revocation"); err != nil {
