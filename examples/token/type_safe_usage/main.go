...
func main() {
	...
	// Create a strongly-typed device info and metadata for the token
	...
	// --- Token Creation ---
	// Create a new token with claims and type-safe metadata
	...
	// --- Token Validation ---
	// Validate token with type safety
	if err != nil {
	...
	// --- Token Operations Demonstration ---
