...
// Description: Demonstrates negative and positive cases for AAP001 Proof of Authorization validation, including invalid jurisdiction, disallowed scope, missing fields, and a valid advanced POA.
...
// Advanced AAP001 Proof of Authorization (POA) scenario demonstrating negative cases and compliance checks.
