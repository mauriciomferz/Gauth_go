// Package agentauth provides types and interfaces for transactions.
package agentauth
...
const (
	...
	// TransactionCanceled indicates a canceled transaction
	TransactionCanceled TransactionStatus = "canceled"
	// TransactionCancelled kept for backward compatibility.
