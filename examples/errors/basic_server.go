...
import (
	...
	"github.com/Gimel-Foundation/gauth/examples/errors/middleware"
...
func resourceHandler(w http.ResponseWriter, r *http.Request) {
	...
	err := errors.New(errors.ErrInsufficientScope, "The token does not have the required scope")
	err = err.WithSource(errors.SourceAuthorization)
	err = err.WithRequestInfo(r.Header.Get("X-Request-ID"), "client-456", "user-789")
