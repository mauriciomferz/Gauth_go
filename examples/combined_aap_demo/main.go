...
func displayAAP001Exclusions(ex aap.AAP001Exclusions) {
...
func displayPPArchitecture(pp aap.AAP001PPArchitecture) {
...
func displayPoADefinition(poa aap.AAP002PoADefinition) {
...
func displayIntegrationStatus(config aap.CombinedRFCConfig) {
...
func createDigitalAgentConfig() aap.AAP001Client {
	return aap.AAP001Client{
		Type:     aap.AAP001ClientTypeDigitalAgent,
...
func createAgenticAIConfig() aap.AAP001Client {
	return aap.AAP001Client{
		Type:     aap.AAP001ClientTypeAgenticAI,
...
func createHumanoidRobotConfig() aap.AAP001Client {
	return aap.AAP001Client{
		Type:     aap.AAP001ClientTypeHumanoidRobot,
