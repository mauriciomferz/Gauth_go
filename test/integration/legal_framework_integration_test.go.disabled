...
func setupTestFramework(_ *testing.T) *auth.LegalFrameworkValidator {
	validator := &auth.LegalFrameworkValidator{}
	validator.Initialize()
	return validator
}

func createAuthorizerProof(_ *testing.T) *auth.LegalFramework {
	return &auth.LegalFramework{
		Jurisdiction:    "US",
		EntityType:      "corporation",
		LegalAuthority:  "commercial_registry_001",
