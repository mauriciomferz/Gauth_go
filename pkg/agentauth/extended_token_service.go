// Package agentauth - Extended Token Creation and Validation per RFC-0111
...
func (s *ExtendedTokenService) generateAccessToken() (string, error) {
	...
	return fmt.Sprintf("agentauth_at_%s", hex.EncodeToString(bytes)), nil
}
...
func (s *ExtendedTokenService) generateRefreshToken() (string, error) {
	...
	return fmt.Sprintf("agentauth_rt_%s", hex.EncodeToString(bytes)), nil
}
