...
func defaultPVPVerifyFunc(ctx context.Context, request *agentauth.IdentityProofRequest) (*agentauth.IdentityProofResult, error) {
...
type MockPIPClient struct {
	...
	clients map[string]*agentauth.ClientInfo
	servers map[string]*agentauth.AuthorizationServerInfo
}
...
func NewMockPIPClient() *MockPIPClient {
	return &MockPIPClient{
		clients: make(map[string]*agentauth.ClientInfo),
		servers: make(map[string]*agentauth.AuthorizationServerInfo),
	}
}
...
type MockCommercialRegisterClient struct {
	...
	// Storage for pre-configured responses
	companies map[string]*agentauth.CompanyInfo
	directors map[string]*agentauth.DirectorInfo
	poas      map[string]*agentauth.PoARegistration
}
...
func NewMockCommercialRegisterClient() *MockCommercialRegisterClient {
	return &MockCommercialRegisterClient{
		companies: make(map[string]*agentauth.CompanyInfo),
		directors: make(map[string]*agentauth.DirectorInfo),
		poas:      make(map[string]*agentauth.PoARegistration),
	}
}
...
func (m *MockCommercialRegisterClient) VerifyCompany(
	...
	return &agentauth.CompanyInfo{
		...
		LegalForm:          "GmbH",
		Status:             "active",
		ManagingDirectors: []*agentauth.DirectorInfo{
			{
...
func (m *MockCommercialRegisterClient) VerifyPowerOfAttorney(
	...
	return &agentauth.PoARegistration{
		PoAID:            poaID,
		PoAType:          "general",
		GrantorID:        companyID,
...
func (m *MockCommercialRegisterClient) GetSignatoryRights(
	...
	return &agentauth.SignatoryRights{
		PersonID:         personID,
...
func (m *MockCommercialRegisterClient) GetCompanyStructure(
	...
	return &agentauth.CompanyStructure{
		CompanyID:           companyID,
		LegalForm:           "GmbH",
