...
func TestMockPowerVerificationPoint(int(t) *) *testing.T) {
	...
	t.Run("custom verify function", func(t *testing.T) {
		...
		mock.WithVerifyFunc(func(ctx context.Context, request *agentauth.IdentityProofRequest) (*agentauth.IdentityProofResult, error) {
...
func TestMockPIPClient(t *testing.T) {
	...
	t.Run("pre-configured client data", func(t *testing.T) {
		...
		mock.AddClient("premium_client", &agentauth.ClientInfo{
...
func TestMockCommercialRegisterClient(t *testing.T) {
	...
	t.Run("pre-configured company data", func(t *testing.T) {
		...
		mock.AddCompany("DE", "HRB99999", &agentauth.CompanyInfo{
			CompanyID:          "HRB99999",
			LegalName:          "Test GmbH",
			Jurisdiction:       "DE",
