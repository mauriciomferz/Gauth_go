// Package agentauth - Tests for geographic scope validation
package agentauth
...
func TestGeographicScopeValidation_Failure(t *testing.T) {
	...
	} else if agentauthErr.Code != "geographic_scope_violation" {
		t.Errorf("Expected error code 'geographic_scope_violation', got '%s'", agentauthErr.Code)
	}
...
func TestGeographicScopeValidation_NoScopeStrict(t *testing.T) {
	...
	if !ok {
		t.Errorf("Expected AgentAuthError, got %T", err)
	} else if agentauthErr.Code != "no_geographic_scope" {
		t.Errorf("Expected error code 'no_geographic_scope', got '%s'", agentauthErr.Code)
	}
}
