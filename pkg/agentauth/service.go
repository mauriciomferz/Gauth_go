...
// WithRFCCompliance configures AAP001 compliance components
// This enables the full AAP001 subscription and authorization flows
func WithRFCCompliance(
	...
	return func(s *Service) error {
		...
		// This completes the P*P architecture integration (AAP001 Section 3.1)
...
func (g *Service) selectValidator() TokenSignatureValidator {
	...
	// EdDSA mode takes highest priority (explicitly set via AGENTAUTH_TOKEN_SIG_MODE env var)
...
// UPDATED: Now uses AAP001 flow by default for RFC compliance
...
// RequestTokenLegacy generates a basic OAuth token (non-AAP001 compliant)
...
// Helper functions for RequestToken AAP001 conversion
