// Package agentauth - AAP001 Protocol Orchestrator (Steps a-i)
...
// ProtocolOrchestrator manages the complete AAP001 request-specific flow (steps a-i)
...
// NewProtocolOrchestrator creates a new AAP001 protocol orchestrator
...
// ExecuteRFCCompliantFlow executes the complete AAP001 request-specific flow (steps a-i)
