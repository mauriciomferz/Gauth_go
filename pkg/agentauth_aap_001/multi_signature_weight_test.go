...
func TestWeightedMultiSignatureSuccess(t *testing.T) {
	...
	t.Setenv("AGENTAUTH_MULTI_SIG_WEIGHTS", "alice=3,bob=2,carol=1")
	t.Setenv("AGENTAUTH_MULTI_SIG_THRESHOLD", "5") // threshold interpreted as weight requirement in verify logic
...
func TestWeightedMultiSignatureInsufficient(t *testing.T) {
	t.Setenv("AGENTAUTH_MULTI_SIG_WEIGHTS", "alice=3,bob=2,carol=1")
	t.Setenv("AGENTAUTH_MULTI_SIG_THRESHOLD", "6") // require weight 6
