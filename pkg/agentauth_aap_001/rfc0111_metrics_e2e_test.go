...
func TestAAP001MetricsE2E(t *testing.T) {
	...
	requiredNames := []string{
		"agentauth_aap001_delegations_created_total", // at least 1
		"agentauth_aap001_validation_latency_seconds_bucket",
		"agentauth_aap001_signatures_issued_total",            // may be zero if signer not configured, tolerate presence absence? we only check presence of name due to registration
		"agentauth_aap001_signature_public_key_missing_total", // soft-skip case may stay zero
	}
	...
	if !containsMetricValue(body, "agentauth_aap001_delegations_created_total", "1") && !containsMetricValue(body, "agentauth_aap001_delegations_created_total", "2") {
