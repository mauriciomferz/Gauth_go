...
func TestPrometheusObligationMetricsIntegration(t *testing.T) {
	...
	mandMF := findMF("gauth_aap001_mandatory_obligation_failures_total")
	...
	failMF := findMF("gauth_aap001_obligations_failed_total")
	...
	execMF := findMF("gauth_aap001_obligations_executed_total")
	...
	latMF := findMF("gauth_aap001_obligation_latency_seconds")
	if latMF == nil {
