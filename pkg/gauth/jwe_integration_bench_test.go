// Package gauth - JWE Integration Benchmarks (Phase 2)
...
func TestJWEIntegration_KeyRotation(t *testing.T) {
	...
	SaveRSAPrivateKey(key1, key1PrivPath)
	SaveRSAPublicKey(&key1.PublicKey, key1PubPath)
	...
	SaveRSAPrivateKey(key2, key2PrivPath)
	SaveRSAPublicKey(&key2.PublicKey, key2PubPath)
