// Package gauth provides formal requirements enforcement for RFC-0111/RFC-0115 compliance
package gauth
...
func (v *FormalRequirementsValidator) ValidateIdentityDocuments(
	...
	for i, doc := range docs {
		...
		result.IssuingAuthValid = result.IssuingAuthValid || docResult.IssuingAuthValid
