...
You can revoke this PoA at any time: https://gauth.example.com/revoke/%s

Monitor activity: https://gauth.example.com/activity/%s
...
Questions? Contact security@gauth.example.com
`,
