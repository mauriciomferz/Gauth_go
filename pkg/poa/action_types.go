...
// ActionCompatibilityCheck validates action set against client type
func ActionCompatibilityCheck(actions *AuthorizedActionSet, client *AuthorizedClient) error {
