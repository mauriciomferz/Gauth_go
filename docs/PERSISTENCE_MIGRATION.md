...
## Overview
The AgentAuth Beta introduces optional persistent storage for Proof of Authorization (PoA) records and audit ledgers using BoltDB. Persistence is activated via the environment variable `AGENTAUTH_PERSIST_PATH`. When set, the service will:
