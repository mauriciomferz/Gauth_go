...
- Evidence: `pkg/rfc0111/canonical.go`, `pkg/rfc0111/canonical_test.go`
...
- Evidence: `pkg/rfc0111/rfc0111.go:POAStatus`
...
- Configurable rotation intervals (GAUTH_KEY_ROTATION_HOURS)
- Evidence: `pkg/crypto/keyring/`, `pkg/crypto/rotation_test.go`
...
- RawPOA embedding with GAUTH_EMBED_FULL_POA flag
- Size cap enforcement (GAUTH_MAX_RAW_POA_BYTES)
- Verifier helper: `ExtractEmbeddedPoA()`
- Enhanced audit logging: `ExtractEmbeddedPoAWithAudit()`
- Offline verification support (GAUTH_OFFLINE_VERIFICATION=1)
- Metrics: IncEnvelopeRawPOAEmbedded, IncEnvelopeRawPOATooLarge
- Evidence: `pkg/rfc0111/rfc0111.go`, `pkg/rfc0111/embedding_test.go`
...
- Evidence: `pkg/rfc0111/multisig.go`, `pkg/rfc0111/multisig_test.go`

### 5. **sec4.item1 - Jurisdiction-specific enforcement** ✅
- Jurisdiction-aware policy evaluation
- Geographic restriction enforcement
- GDPR/regulatory compliance hooks
- Evidence: `pkg/rfc0111/jurisdiction.go`, `pkg/rfc0111/jurisdiction_test.go`
...
- Factory pattern integration with gauth.Service
- Environment-based auto-configuration:
  - GAUTH_REPLAY_WAL_PATH (default: ./data/replay.wal)
  - GAUTH_REPLAY_TTL_SEC (default: 900)
  - GAUTH_REPLAY_EVICTION_POLICY (ttl|lru|size|ttl+size)
  - GAUTH_REPLAY_EVICTION_MAX_SIZE (default: 10000)
- Fail-closed semantics: CheckAndStore() rejects duplicates with error
- Evidence: `pkg/replay/durable_replay_store.go`, `pkg/replay/gauth_factory.go`, `pkg/replay/gauth_autoconfig_test.go`
...
- Evidence: `pkg/rfc0111/validator_semantic_prop_test.go`, `pkg/rfc0111/canonical_digest_test.go`
...
**Cryptography:**
- `GAUTH_TOKEN_SIG_MODE`: Signature mode (hmac|eddsa)
- `GAUTH_KEY_ROTATION_HOURS`: Key rotation interval (default: 24)

**Embedding:**
- `GAUTH_EMBED_FULL_POA`: Enable PoA embedding (0|1)
- `GAUTH_MAX_RAW_POA_BYTES`: Max embedded PoA size (default: 8192)
- `GAUTH_OFFLINE_VERIFICATION`: Enable offline verification (0|1)

**Replay Protection:**
- `GAUTH_REPLAY_WAL_PATH`: WAL file path (default: ./data/replay.wal)
- `GAUTH_REPLAY_TTL_SEC`: JTI TTL in seconds (default: 900)
- `GAUTH_REPLAY_EVICTION_POLICY`: Eviction strategy (ttl|lru|size|ttl+size)
- `GAUTH_REPLAY_EVICTION_MAX_SIZE`: Max replay store size (default: 10000)

**Audit:**
- `GAUTH_AUDIT_QUEUE_SIZE`: Audit event queue buffer (default: 1000)
- `GAUTH_JTI_TTL_SEC`: JTI validity window (default: 600)
