...
**Issue**: Initial test used `github.com/mauriciomferz/AgentAuth/pkg/authz` but actual module is `github.com/agentauth/AAP-RFC-0150-Go-Implementation-of-AgentAuth-1.0`
