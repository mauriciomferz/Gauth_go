...
> Demonstration patterns only – NOT production ready. These examples trade completeness for clarity. See `../DISCLAIMER.md` for missing safeguards (multi-tenant isolation, exhaustive validation, abuse detection, etc.).
