...
| RFC & Standards Compliance | RFC 0111/0115 specs, matrices, gap analysis | `RFC0111_README.md`, `docs/rfc/rfc0111.md`, `docs/rfc/rfc0115.md`, `docs/rfc_endpoint_mapping.md`, `docs/rfc0111_compliance_matrix.md` | `docs/rfc/`, `docs/*RFC*` | Compliance Lead |
...
| Compliance Reports & Assessments | Formal compliance status docs | `COMPLIANCE_PROGRESS_UPDATE_NOV_12_2025.md`, `docs/COMPLIANCE_IMPLEMENTATION.md`, `docs/COMPLIANCE_SUMMARY.md`, `docs/COMPLIANCE_ASSESSMENT.md`, `docs/COMPLIANCE_RFC111_RFC115_REPORT.md` | varied | Compliance |
