...
| RFC & Standards Compliance | AAP-001/0115 specs, matrices, gap analysis | `AAP-001_README.md`, `docs/rfc/aap001.md`, `docs/rfc/aap002.md`, `docs/rfc_endpoint_mapping.md`, `docs/aap001_compliance_matrix.md` | `docs/rfc/`, `docs/*RFC*` | Compliance Lead |
