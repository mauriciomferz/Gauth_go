...
## Phase 26: Frontend Maintenance [x]
- [x] Fix ESLint v9 configuration error in `frontend/ui-react`
    - [x] Install `globals`, `@eslint/js`, `typescript-eslint`
    - [x] Create `eslint.config.js` with flat config
    - [x] Resolve linting errors to allow build to pass
