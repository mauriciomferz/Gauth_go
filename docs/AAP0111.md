...
on it may be obtained at https://gimelfoundation.com or https://github.com/AgentAuthFoundation.
...
Documents (see http://AgentAuthFoundation.com or https://github.com/AgentAuth-Foundation)
in e]ect on the date of publication of this document. Please review these documents
AgentAuth Community gGmbH i.G., www.AgentAuthFoundation.com, Operated by AgentAuth Technologies GmbH:
...
┌─────────────────────────────────────────────────────────────────────────────┐
│                    GAUTH AUTHORIZATION COMPONENTS                           │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
