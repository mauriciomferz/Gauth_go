...
> Beta demonstration repository – NOT production ready. Tests illustrate patterns, not assurance. See `../DISCLAIMER.md` for missing hardening and compliance scope.
