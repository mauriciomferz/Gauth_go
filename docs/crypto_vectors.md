...
This document defines the unified `Signer` interface, encoding rules, and canonical test vector guidance for Ed25519, ECDSA (P‑256), and BLS12‑381 used in AgentAuth.
