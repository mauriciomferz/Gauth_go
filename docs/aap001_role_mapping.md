...
# AAP-001 Role Mapping (Beta MVP)

Date: 2025-10-29

This document maps conceptual AAP-001 actors & functional planes (traditional OAuth-style roles + AgentAuth P*P components) to current code artifacts or identifies gaps.
