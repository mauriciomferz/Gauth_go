...
test_endpoint "Get Active Successor" "GET" "/api/v1/agentauthplus/successors/active/$TEST_POA_ID"
test_endpoint "Get Successor History" "GET" "/api/v1/agentauthplus/successors/history/$TEST_POA_ID"

# Delegation Management
test_endpoint "Get Delegation Chain" "GET" "/api/v1/agentauthplus/delegations/chain/$TEST_AGENT_ID"

# Dual Control
test_endpoint "Get Pending Approvals" "GET" "/api/v1/agentauthplus/dual-control/approvals/pending"

# Capability Assessment (404 is OK if no data exists)
echo -n "Testing Get Latest Assessment... "
response=$(curl -s -w "\n%{http_code}" -X GET "$BACKEND_URL/api/v1/agentauthplus/capabilities/agents/$TEST_AGENT_ID/latest")
status_code=$(echo "$response" | tail -n1)
...
# Fiduciary Duty
test_endpoint "Get Violations" "GET" "/api/v1/agentauthplus/fiduciary/violations"
...
admin_status=$(curl -s -o /dev/null -w "%{http_code}" "$FRONTEND_URL/admin/agentauthplus" 2>/dev/null || echo "000")
...
API_CLIENT="frontend/ui-react/src/lib/agentauthplus-api.ts"
...
PANELS=(
    "frontend/ui-react/src/components/agentauthplus/SuccessorPanel.tsx"
    "frontend/ui-react/src/components/agentauthplus/DelegationPanel.tsx"
    "frontend/ui-react/src/components/agentauthplus/DualControlPanel.tsx"
    "frontend/ui-react/src/components/agentauthplus/CapabilityPanel.tsx"
    "frontend/ui-react/src/components/agentauthplus/FiduciaryPanel.tsx"
)
...
if [ $TESTS_FAILED -eq 0 ]; then
    ...
    echo "Access at: $FRONTEND_URL/admin/agentauthplus"
    exit 0
else
