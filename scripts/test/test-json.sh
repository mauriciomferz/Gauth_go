...
#   AGENTAUTH_DISABLE_BG_POLLS=1 AGENTAUTH_SKIP_SMOKETEST=1 applied by default unless QUIET_FLAGS=0.
...
if [ "${QUIET_FLAGS:-1}" = "1" ]; then
  QUIET_ENV="SKIP_WEB_ASSETS=1 AGENTAUTH_DISABLE_BG_POLLS=1 AGENTAUTH_SKIP_SMOKETEST=1"
fi
