...
REQUIRED_FILES=(
    ...
    "deployments/k8s/staging/bluegreen/agentauth-deployment-blue.yaml"
    "deployments/k8s/staging/bluegreen/agentauth-deployment-green.yaml"
    "deployments/k8s/staging/bluegreen/agentauth-services.yaml"
    "deployments/k8s/staging/bluegreen/agentauth-ingress-bluegreen.yaml"
...
echo -e "      https://github.com/mauriciomferz/AgentAuth/settings/secrets/actions"
echo ""
...
echo -e "      https://github.com/mauriciomferz/AgentAuth/actions"
echo ""
